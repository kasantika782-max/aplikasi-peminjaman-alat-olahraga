...
|--------------------------------------------------------------------------
*/
if (!isset($_SESSION['role'], $_SESSION['id_user'])) {
    ...
    <div class="bg-white rounded-2xl shadow-xl border border-slate-200 p-6 md:p-8">
        ...
        <form action="../controller/c_peminjaman.php?aksi=tambah_admin"
            ...
            <div class="mb-5">
                ...
                <input type="hidden"
                       name="id_user"
                       value="<?= (int)($_SESSION['id_user'] ?? 0); ?>">

                <div class="w-full px-4 py-3 border border-indigo-200 bg-indigo-50 text-indigo-700 rounded-xl font-semibold">
                    <i class="fa-solid fa-user-shield mr-2"></i>
                    <?= htmlspecialchars($_SESSION['username'] ?? 'Admin yang sedang login'); ?>
                    <span class="text-xs font-medium text-indigo-500 ml-1">(Admin)</span>
                </div>

                <p class="text-xs text-slate-500 mt-2">
                    Peminjaman ini dicatat atas nama Admin yang sedang login.
                </p>
            </div>
            ...
            <div class="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-6">
                <p class="text-sm text-amber-800">
                    ...
                    Peminjaman oleh Admin langsung dicatat sebagai dipinjam dan stok alat akan berkurang.
                </p>
            </div>
